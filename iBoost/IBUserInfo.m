...
+ (id)topic:(NSString*)topic strongRef:(id)strongRef weakRef:(id)weakRef {
  return [[[IBUserInfo alloc] initWithTopic:topic strongRef:strongRef weakRef:weakRef] autorelease];
}


//////////////////////////////////////////////////////////////////////////////////////////////////
+ (id)topic:(NSString*)topic {
  return [[[IBUserInfo alloc] initWithTopic:topic strongRef:nil weakRef:nil] autorelease];
}


//////////////////////////////////////////////////////////////////////////////////////////////////
+ (id)weakRef:(id)weakRef {
  return [[[IBUserInfo alloc] initWithTopic:nil strongRef:nil weakRef:weakRef] autorelease];
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  RELEASE_AND_NIL(_topic);
  RELEASE_AND_NIL(_strongRef);
  [super dealloc];
}
