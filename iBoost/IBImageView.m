...
- (void)dealloc {
  _delegate = nil;
  [_request cancel];
  RELEASE_AND_NIL(_request);
  RELEASE_AND_NIL(_urlPath);
  RELEASE_AND_NIL(_image);
  RELEASE_AND_NIL(_defaultImage);
  [super dealloc];
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
#pragma mark IBURLRequestDelegate
...
- (void)requestDidFinishLoad:(IBURLRequest*)request {
  IBURLImageResponse* response = request.response;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
#pragma mark IBStyleDelegate


///////////////////////////////////////////////////////////////////////////////////////////////////
/* JEBBY
- (void)drawLayer:(IBStyleContext*)context withStyle:(IBStyle*)style {
  if ([style isKindOfClass:[IBContentStyle class]]) {
...
- (void)reload {
  if (nil == _request && nil != _urlPath) {
    UIImage* image = [[IBURLCache sharedCache] imageForURL:_urlPath];

    if (nil != image) {
      self.image = image;

    } else {
      IBURLRequest* request = [IBURLRequest requestWithURL:_urlPath delegate:self];
      request.response = [[[IBURLImageResponse alloc] init] autorelease];
