...
/**
 * A response protocol for IBURLRequest. This protocol is used upon the successful retrieval of
 * data from a IBURLRequest. The processResponse method is used to process the data, whether it
 * be an image or an XML string.
 *
 * @see IBURLDataResponse
 * @see IBURLImageResponse
 */
@protocol IBURLResponse <NSObject>
@required
 ...
 * @param  data       The data received from the IBURLRequest.
